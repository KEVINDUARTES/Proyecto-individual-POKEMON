...
import { getDetail } from "../store/actions/index.js";//me pasa un id
import { Link } from "react-router-dom";
import './Detail.css'

export default function Detail(props) {
  const dispatch = useDispatch();// me trigo la accion
  useEffect(() => {
    dispatch(getDetail(props.match.params.id));//despacho la accion
  }, [dispatch]);

  let details = useSelector((state) => state.detail);//me traigo el estado de detail de reducer
console.log(details)
  return (
